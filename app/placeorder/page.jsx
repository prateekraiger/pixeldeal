  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      window.sessionStorage.setItem(
        "orderDetails",
        JSON.stringify({ method, totalPrice, deliveryInfo })
      );
    ...
    <Background>
      <div className="flex flex-col sm:flex-row justify-between gap-8 pt-5 sm:pt-14 px-4 sm:px-8 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col gap-4 w-full sm:w-1/2">
          <div className="text-xl sm:text-2xl my-3 font-bold text-orange-600">
          ...
          {formErrors.pincode && (
            <span className="text-red-500 text-sm">{formErrors.pincode}</span>
          )}
          {formErrors.country && (
          ...
          <div className="mt-4">
            ...
            {Object.keys(formErrors).length > 0 && (
              <div className="mt-2 text-red-600 text-sm font-semibold">
                Please fill all required delivery information correctly:{" "}
