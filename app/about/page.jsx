  ...
  return (
    <div className="relative min-h-screen">
      ...
      <motion.div
        ...
        className="w-full py-8 min-h-screen relative z-10"
      >
        <div className="w-full">
          ...
          >
            ...
            >
              ...
              >
                NextGadget was founded in 2018 with a simple mission: to provide
                tech enthusiasts with premium electronic products at competitive
                prices. What began as a small online store has grown into a
                trusted destination for quality electronics, serving customers
                across the country.
              </motion.p>
              <motion.p
                variants={fadeUp}
                className="text-gray-700 mb-4 text-sm sm:text-base md:text-lg"
              >
                Our founder, Sarah Chen, recognized a gap in the market for an
                electronics retailer that combines technical expertise with
                exceptional customer service. Drawing from her background in
                tech and e-commerce, she assembled a team of passionate tech
                lovers who share her vision of making the latest technology
              ...
              >
                Today, NextGadget offers a carefully curated selection of
                electronic products, from cutting-edge laptops and smartphones
                to high-performance peripherals and accessories. We continue to
                grow and evolve, but our core values remain the same: quality,
          ...
          >
            ...
            >
              ...
              <motion.p
                ...
                className="text-gray-700 text-sm sm:text-base md:text-lg"
              >
                At NextGadget, our mission is to empower people through
                technology by providing premium electronic products, expert
                guidance, and exceptional customer service. We believe that the
                right tech tools can enhance productivity, creativity, and
            ...
            >
              ...
              <motion.p
                ...
                className="text-gray-700 text-sm sm:text-base md:text-lg"
              >
                We envision a future where everyone has access to quality
                technology that enhances their lives. By curating the best
                products and providing excellent service, we aim to be the most
                trusted name in electronics retail, known for our integrity,
