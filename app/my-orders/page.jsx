      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col justify-between px-4 sm:px-6 md:px-16 lg:px-32 py-6 min-h-screen bg-gray-50">
          <div className="space-y-5">
            <h2 className="text-xl md:text-2xl font-semibold mt-6 text-gray-800">
              My Orders
            </h2>
            {!user && !loading && (
            ...
            {loading ? (
              ...
              <div className="max-w-5xl mx-auto border-t border-gray-200 text-sm">
                ...
                {orders.map((order, index) => (
                  ...
                  <div
                    key={order._id || index}
                    className="flex flex-col md:flex-row gap-4 md:gap-5 justify-between p-4 md:p-5 border-b border-gray-200 bg-white rounded-md shadow-sm mb-4"
                  >
                    ...
                    <div className="flex items-start gap-3 md:gap-4 flex-grow md:flex-none md:w-2/5">
                      <Image
                        ...
                        alt="order_icon"
                        width={48}
                        height={48} // Added width/height for Image component
                      />
                      <div className="flex flex-col gap-1">
                        {order.items?.map((item, itemIndex) => (
                          ...
                          >
                            {item.product?.name || "Product Name Missing"} x{" "}
                            {item.quantity}
                          </p>
                        ))}
                    ...
                    <div className="flex justify-between items-center md:flex-col md:items-end md:justify-start md:flex-none md:w-1/5 pt-2 md:pt-0 border-t md:border-none mt-2 md:mt-0">
                      ...
                      <button className="mt-1 md:mt-3 bg-orange-100 text-orange-600 px-3 py-1 rounded text-xs font-medium hover:bg-orange-200 whitespace-nowrap">
                        Track Order
                      </button>
                    </div>
                  </div>
